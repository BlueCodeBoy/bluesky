...
/**
 * This takes care of the external metadata injection into the TableInputMetaForSpark class
 *
 * @author Chris
 */
public class TableInputMetaInjection implements StepMetaInjectionInterface {
  ...
  public TableInputMetaInjection( TableInputMetaForSpark meta ) {
    this.meta = meta;
  }
  ...
  public TableInputMetaForSpark getMeta() {
    return meta;
  }
}
