 ...
 * @since 8-apr-2003
 */
public class TableInputForSpark extends BaseStep implements StepInterface {
  private static Class<?> PKG = TableInputMetaForSpark.class; // for i18n purposes, needed by Translator2!!

  private TableInputMetaForSpark meta;
  private TableInputDataForSpark data;

  public TableInputForSpark(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr, TransMeta transMeta,
                            Trans trans ) {
  ...
  public void stopRunning( StepMetaInterface smi, StepDataInterface sdi ) throws KettleException {
    meta = (TableInputMetaForSpark) smi;
    data = (TableInputDataForSpark) sdi;
