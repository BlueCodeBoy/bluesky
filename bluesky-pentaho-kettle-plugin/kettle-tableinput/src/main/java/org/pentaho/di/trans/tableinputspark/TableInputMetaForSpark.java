...
package org.pentaho.di.trans.tableinputspark;
...
@Step(
        id = "SparkTableInput",
        image = "org/pentaho/di/trans/tableinputspark/resources/table.png",
        i18nPackageName = "org.pentaho.di.trans.tableinputspark",
        name = "TableInput.Shell.Title",
        description = "TableInput.Shell.Tooltip",
        documentationUrl = "TableInput.Shell.DocumentationURL",
        casesUrl = "TableInput.Shell.CasesURL",
        categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Input")
public class TableInputMetaForSpark extends BaseStepMeta implements StepMetaInterface {
    ...
    private String numParttion;

    public String getNumParttion() {
        return numParttion;
    }

    public void setNumParttion(String numParttion) {
        this.numParttion = numParttion;
    }
    ...
    public Object clone() {
        TableInputMetaForSpark retval = (TableInputMetaForSpark) super.clone();
        return retval;
    }
    ...
    private void readData(Node stepnode, List<? extends SharedObjectInterface> databases) throws KettleXMLException {
        try {
            ...
            primaryKey = XMLHandler.getTagValue(stepnode, "primaryKey");
            numParttion = XMLHandler.getTagValue(stepnode, "numParttion");
    ...
    public String getXML() {
        ...
        retval.append("    " + XMLHandler.addTagValue("primaryKey", primaryKey));
        retval.append("    " + XMLHandler.addTagValue("tableName", tableName));
        retval.append("    " + XMLHandler.addTagValue("numParttion", numParttion));
        StreamInterface infoStream = getStepIOMeta().getInfoStreams().get(0);
    ...
    public void readRep(Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases) throws KettleException {
        try {
            ...
            numParttion = rep.getStepAttributeString(id_step, "numParttion");
            if (numParttion == null) {
                numParttion = Long.toString(rep.getStepAttributeInteger(id_step, "numParttion"));
            }
    ...
    public void saveRep(Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step) throws KettleException {
        try {
            ...
            rep.saveStepAttribute(id_transformation, id_step, "numParttion", numParttion);
            rep.saveStepAttribute(id_transformation, id_step, "limit", rowLimit);
            rep.saveStepAttribute(id_transformation, id_step, "primaryKey", primaryKey);
    ...
    public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
        ...
        return new TableInputForSpark(stepMeta, stepDataInterface, cnr, transMeta, trans);
    }

    public StepDataInterface getStepData() {
        return new TableInputDataForSpark();
    }
