...
package org.pentaho.di.trans.mergejoin;
...
@Step(
        id = "SparkMergeJoin",
        image = "org/pentaho/di/trans/mergejoin/resources/left-join.png",
        i18nPackageName = "org.pentaho.di.trans.mergejoin",
        name = "Mergejoin.Shell.Title",
        description = "Mergejoin.Shell.Tooltip",
        documentationUrl = "Mergejin.Shell.DocumentationURL",
        casesUrl = "Merejoin.Shell.CasesURL",
        categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Input")
public class MergeJoinMetaForSpark extends BaseStepMeta implements StepMetaInterface {
  private static Class<?> PKG = MergeJoinMetaForSpark.class; // for i18n purposes, needed by Translator2!!

  public static final String[] join_types = { "INNER", "LEFT_OUTER", "RIGHT_OUTER", "FULL_OUTER" };
 // public static final String[] join_types = {  "inner", "outer", "left_outer", "right_outer", "leftsemi"};
  ...
  public Object clone() {
    MergeJoinMetaForSpark retval = (MergeJoinMetaForSpark) super.clone();
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr, TransMeta tr,
                                Trans trans ) {
    return new MergeJoinForSpark( stepMeta, stepDataInterface, cnr, tr, trans );
  }

  public StepDataInterface getStepData() {
    return new MergeJoinDataForSpark();
  }
