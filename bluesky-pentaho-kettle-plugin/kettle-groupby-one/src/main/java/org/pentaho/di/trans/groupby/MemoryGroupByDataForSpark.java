 ...
 *
 */
public class MemoryGroupByDataForSpark extends BaseStepData implements StepDataInterface {
  ...
  public HashMap<HashEntry, AggregateForSpark> map;
  ...
  public MemoryGroupByDataForSpark() {
    super();
   ...
   */
  public void clear() {
    map = new HashMap<HashEntry, AggregateForSpark>();
  }
}
