...
@Step(
        id = "SparkGroupBy",
        image = "org/pentaho/di/trans/groupby/resources/groupby.png",
        i18nPackageName = "org.pentaho.di.trans.groupby",
        name = "SparkMemoryGroupByDialog.Shell.Title",
        description = "SparkMemoryGroupByDialog.Shell.Tooltip",
        documentationUrl = "MemoryGroupByDialog.Shell.DocumentationURL",
        casesUrl = "MemoryGroupByDialog.Shell.CasesURL",
        categoryDescription = "i18n:org.pentaho.di.trans.step:BaseStep.Category.Input")

public class MemoryGroupByMetaForSpark extends BaseStepMeta implements StepMetaInterface {
  ...
  public MemoryGroupByMetaForSpark() {
  ...
  public Object clone() {
    MemoryGroupByMetaForSpark retval = (MemoryGroupByMetaForSpark) super.clone();
  ...
  public StepInterface getStep( StepMeta stepMeta, StepDataInterface stepDataInterface, int cnr,
    ...
    return new MemoryGroupByForSpark( stepMeta, stepDataInterface, cnr, transMeta, trans );
  }

  public StepDataInterface getStepData() {
    return new MemoryGroupByDataForSpark();
  }
