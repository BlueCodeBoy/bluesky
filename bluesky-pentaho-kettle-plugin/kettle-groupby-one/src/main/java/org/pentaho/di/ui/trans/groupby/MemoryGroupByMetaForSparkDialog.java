...
package org.pentaho.di.ui.trans.groupby;
...
import org.pentaho.di.trans.groupby.MemoryGroupByMetaForSpark;
...
public class MemoryGroupByMetaForSparkDialog extends BaseStepDialog implements StepDialogInterface {
...
//  private FormData fdlAlwaysAddResult, fdAlwaysAddResult;
  ...
  private MemoryGroupByMetaForSpark input;
  ...
  public MemoryGroupByMetaForSparkDialog(Shell parent, Object in, TransMeta transMeta, String sname ) {
    super( parent, (BaseStepMeta) in, transMeta, sname );
    input = (MemoryGroupByMetaForSpark) in;
  ...
  public String open() {
    ...
    shell.setText( BaseMessages.getString( PKG, "SparkMemoryGroupByDialog.Shell.Title" ) );
