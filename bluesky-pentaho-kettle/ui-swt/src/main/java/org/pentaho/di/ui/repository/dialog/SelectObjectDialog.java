...
public class SelectObjectDialog extends Dialog {
  ...
  public String open() {
    ...
    try {
      ...
      if (e.getMessage().contains("Ensure that you have called .close() on any active streaming " +
              "result sets before attempting more queries")){
        MessageDialog.openInformation(shell,
                BaseMessages.getString( PKG, "SelectObjectDialog.Dialog.StreamClosed.Title" ),
                BaseMessages.getString( PKG, "SelectObjectDialog.Dialog.StreamClosed.Message" ));
      } else {
