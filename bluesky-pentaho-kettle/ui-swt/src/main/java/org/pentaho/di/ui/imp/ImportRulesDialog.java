...
public class ImportRulesDialog extends Dialog implements XulEventHandler {
  ...
  public boolean open() {
    ...
    fdToolbar.bottom = new FormAttachment( 20, 0 );
    ...
    enabledColumn.setText(BaseMessages.getString( PKG,"ImportRulesDialog.enabled") );
    enabledColumn.setWidth( 100 );

    // Rule description column
    //
    TableColumn descriptionColumn = new TableColumn( table, SWT.NONE );
    descriptionColumn.setText(BaseMessages.getString( PKG,"ImportRulesDialog.desc"));
    descriptionColumn.setWidth( 400 );

    // Rule description column
    //
    TableColumn compositeColumn = new TableColumn( table, SWT.NONE );
    compositeColumn.setText(BaseMessages.getString( PKG,"ImportRulesDialog.setting"));
