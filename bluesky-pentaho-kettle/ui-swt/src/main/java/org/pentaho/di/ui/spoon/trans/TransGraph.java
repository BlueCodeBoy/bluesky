...
public class TransGraph extends AbstractGraph implements XulEventHandler, Redrawable, TabItemInterface,
  ...
  public int showRunning() throws KettleException{
    MessageBox mb = new MessageBox( shell, SWT.YES | SWT.NO | SWT.ICON_WARNING );
    mb.setMessage( BaseMessages.getString( PKG, "Spoon.ErrorDialog.ShowRunning.Transformation.Message"));
    mb.setText( BaseMessages.getString( PKG, "Spoon.ErrorDialog.ShowRunning.Job.Tile" ) );
    return mb.open();
  }
