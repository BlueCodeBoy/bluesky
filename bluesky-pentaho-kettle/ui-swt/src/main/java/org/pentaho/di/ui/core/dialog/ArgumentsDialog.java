...
public class ArgumentsDialog extends Dialog {
  ...
  public ArgumentsDialog( final Shell parent, ExecutionConfiguration configuration, AbstractMeta abstractMeta ) {
    ...
    okButton.setText( BaseMessages.getString( PKG, "ArgumentsDialog.Button.Ok.Label" ) );
    ...
    cancelButton.setText( BaseMessages.getString( PKG, "ArgumentsDialog.Button.Cancel.Label" ) );
