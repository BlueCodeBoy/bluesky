...
public class DialogUtils {
  ...
  public static void nullDirInfo(Shell shell) {
    MessageDialog.openInformation(shell, BaseMessages.getString(JobEntryFTPSGet.class, "JobFTPS.FolderExists.TITLE"),
            BaseMessages.getString(JobEntryFTPSGet.class, "JobFTPS.FolderExists.MESSAGE"));
  }
}
