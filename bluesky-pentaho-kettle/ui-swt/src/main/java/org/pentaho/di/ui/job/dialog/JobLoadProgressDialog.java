      ...
      public void run( IProgressMonitor monitor ) throws InvocationTargetException, InterruptedException {
        try {
          ...
          if( jobInfo.hasMissingPlugins() ) {
            if(jobInfo.hasManyPeople()) {
              MessageDialog.openInformation(shell, BaseMessages.getString(Spoon.class, "Spoon.ErrorDialog.ShowDetails.Tip"),
                      BaseMessages.getString(Spoon.class, "Spoon.ErrorDialog.ShowDetails.text"));
              jobInfo = null;
            }else {
