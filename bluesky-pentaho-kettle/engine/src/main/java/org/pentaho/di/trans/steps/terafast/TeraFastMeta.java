...
public class TeraFastMeta extends AbstractStepMeta {
   ...
   * {@inheritDoc}
   *
   * @see org.pentaho.di.trans.step.StepMetaInterface#check(List, org.pentaho.di.trans.TransMeta,
   *      StepMeta, org.pentaho.di.core.row.RowMetaInterface, String[],
   *      String[], org.pentaho.di.core.row.RowMetaInterface)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.pentaho.di.trans.step.StepMetaInterface#getStep(StepMeta,
   *      StepDataInterface, int, org.pentaho.di.trans.TransMeta, org.pentaho.di.trans.Trans)
   */
   ...
   * {@inheritDoc}
   *
   * @see org.pentaho.di.trans.step.BaseStepMeta#getFields(org.pentaho.di.core.row.RowMetaInterface, String,
   *      org.pentaho.di.core.row.RowMetaInterface[], StepMeta,
