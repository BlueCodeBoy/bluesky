...
public class JobEntryLogTable extends BaseLogTable implements Cloneable, LogTableInterface {
  ...
  public static JobEntryLogTable getDefault( VariableSpace space, HasDatabasesInterface databasesInterface ) {
    ...
    //2017-11-11 by llj 修改日志表ID_JOB项由ValueMetaInterface.TYPE_INTEGER 8改为ValueMetaInterface.TYPE_INTEGER 18
    table.fields.add( new LogTableField( ID.ID_BATCH.id, true, false, "ID_BATCH", BaseMessages.getString( PKG, "JobEntryLogTable.FieldName.IdBatch" ), BaseMessages.getString( PKG, "JobEntryLogTable.FieldDescription.IdBatch" ), ValueMetaInterface.TYPE_INTEGER, 18 ) );
