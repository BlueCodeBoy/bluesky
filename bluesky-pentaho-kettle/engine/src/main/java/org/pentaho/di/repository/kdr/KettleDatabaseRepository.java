...
public class KettleDatabaseRepository extends KettleDatabaseRepositoryBase {
  ...
  public void save( RepositoryElementInterface repositoryElement, String versionComment,
    ...
    try {
      ...
      //
      commit();
      //出现异常进行回滚 2017-11-17 by llj
    }catch ( KettleDatabaseException dbe ) {
      rollback();
      throw new KettleException( BaseMessages.getString(
              PKG, "Meta.Exception.UnableToSaveInRepositoryRollbackPerformed" ), dbe );
      //2017-11-17 by llj end
  ...
  public synchronized void deleteSlave( ObjectId id_slave ) throws KettleException {
    deleteSlaveWithTransaction(id_slave,true);
  }

  public synchronized void deleteSlaveWithTransaction( ObjectId id_slave,boolean isTransaction ) throws KettleException {
  ...
  public synchronized void deletePartitionSchema( ObjectId id_partition_schema ) throws KettleException {
    deletePartitionSchemaWithTransaction(id_partition_schema,true);
  }
  public synchronized void deletePartitionSchemaWithTransaction( ObjectId id_partition_schema,boolean isTransaction ) throws KettleException {
  ...
  public synchronized void deleteClusterSchema( ObjectId id_cluster ) throws KettleException {
    deleteClusterSchemaWithTransaction(id_cluster,true);
  }
  public synchronized void deleteClusterSchemaWithTransaction( ObjectId id_cluster ,boolean isTransaction) throws KettleException {
  ...
  public synchronized void deleteTransformation( ObjectId id_transformation ) throws KettleException {
    deleteTransformationWithTransaction(id_transformation,true);
  }
  public synchronized void deleteTransformationWithTransaction( ObjectId id_transformation,boolean isTransaction ) throws KettleException {
  ...
  public synchronized void deleteJob( ObjectId id_job ) throws KettleException {
    deleteJobWithTransaction(id_job,true);
  }
  public synchronized void deleteJobWithTransaction( ObjectId id_job ,boolean isTransaction) throws KettleException {
  ...
  public synchronized void closeLookupPreparedStatement() {
    connectionDelegate.closeLookupPreparedStatement();
  }
