...
public class TeraFast extends AbstractStep implements StepInterface {
   ...
   * {@inheritDoc}
   *
   * @see org.pentaho.di.trans.step.BaseStep#init(StepMetaInterface,
   *      StepDataInterface)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.pentaho.di.trans.step.BaseStep#processRow(StepMetaInterface,
   *      StepDataInterface)
   */
  @Override
   ...
   * {@inheritDoc}
   *
   * @see org.pentaho.di.trans.step.BaseStep#dispose(StepMetaInterface,
   *      StepDataInterface)
   */
  @Override
