...
public class SetVariableMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  private static final String[] variableTypeDesc = {
          BaseMessages.getString( PKG, "SetVariableDialog.VariableType.jvm" ),
          BaseMessages.getString( PKG, "SetVariableDialog.VariableType.pjob" ),
          BaseMessages.getString( PKG, "SetVariableDialog.VariableType.gpjob" ),
          BaseMessages.getString( PKG, "SetVariableDialog.VariableType.rjob" )};
