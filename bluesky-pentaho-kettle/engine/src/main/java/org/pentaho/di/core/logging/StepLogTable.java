...
public class StepLogTable extends BaseLogTable implements Cloneable, LogTableInterface {
  ...
  public static StepLogTable getDefault( VariableSpace space, HasDatabasesInterface databasesInterface ) {
    ...
    table.fields.add( new LogTableField( ID.ID_BATCH.id, true, false, "ID_BATCH", BaseMessages.getString( PKG, "StepLogTable.FieldName.IdBatch" ), BaseMessages.getString( PKG, "StepLogTable.FieldDescription.IdBatch" ), ValueMetaInterface.TYPE_INTEGER, 18 ) );
