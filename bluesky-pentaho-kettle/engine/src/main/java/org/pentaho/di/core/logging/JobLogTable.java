...
public class JobLogTable extends BaseLogTable implements Cloneable, LogTableInterface {
  ...
  public static JobLogTable getDefault( VariableSpace space, HasDatabasesInterface databasesInterface ) {
    ...
    //2017-11-11 by llj 修改日志表ID_JOB项由ValueMetaInterface.TYPE_INTEGER 8 改为ValueMetaInterface.TYPE_INTEGER 18
    table.fields.add( new LogTableField( ID.ID_JOB.id, true, false, "ID_JOB", BaseMessages.getString( PKG, "JobLogTable.FieldName.BatchID" ), BaseMessages.getString( PKG, "JobLogTable.FieldDescription.BatchID" ), ValueMetaInterface.TYPE_INTEGER, 18 ) );
