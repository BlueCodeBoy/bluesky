...
public class PerformanceLogTable extends BaseLogTable implements Cloneable, LogTableInterface {
  ...
  public static PerformanceLogTable getDefault( VariableSpace space, HasDatabasesInterface databasesInterface ) {
    ...
    //2017-11-11 by llj 修改日志表ID_BATCH项由ValueMetaInterface.TYPE_INTEGER 8改为ValueMetaInterface.TYPE_INTEGER 18
    table.fields.add( new LogTableField( ID.ID_BATCH.id, true, false, "ID_BATCH", BaseMessages.getString( PKG, "PerformanceLogTable.FieldName.BatchID" ), BaseMessages.getString( PKG, "PerformanceLogTable.FieldDescription.BatchID" ), ValueMetaInterface.TYPE_INTEGER, 18 ) );
