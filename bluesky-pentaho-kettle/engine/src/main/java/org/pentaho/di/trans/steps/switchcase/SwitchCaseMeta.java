...
public class SwitchCaseMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  public String getXML() {
    ...
    retval.append( XMLHandler.addTagValue( "case_value_type", ValueMeta.getTypeDesc( Integer.valueOf(caseValueType==""?"0":caseValueType) ) ) );
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step ) throws KettleException {
    try {
      ...
      rep.saveStepAttribute( id_transformation, id_step, "case_value_type", ValueMeta.getTypeDesc( Integer.valueOf(caseValueType) ) );
