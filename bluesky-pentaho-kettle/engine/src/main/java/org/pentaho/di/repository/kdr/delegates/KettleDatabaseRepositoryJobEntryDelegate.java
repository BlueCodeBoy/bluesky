        ...
        if ( jobEntryCopy.getEntry() == null ) {
          ...
          if ( rt != null ) {
            ...
            if( jobEntry != null ) {
              ...
              //System.out.println("loadJobEntryCopy:[repository="+repository.toString()+",repository.metaStore="+repository.metaStore.toString()+",jobEntryId="+jobEntryId+",databases="+databases.toString()+",slaveServers="+slaveServers);
