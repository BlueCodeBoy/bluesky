...
public class MetricsLogTable extends BaseLogTable implements Cloneable, LogTableInterface {
  ...
  public static MetricsLogTable getDefault( VariableSpace space, HasDatabasesInterface databasesInterface ) {
    ...
    table.fields.add( new LogTableField( ID.ID_BATCH.id, true, false, "ID_BATCH", BaseMessages.getString( PKG, "MetricsLogTable.FieldName.IdBatch" ), BaseMessages.getString( PKG, "MetricsLogTable.FieldDescription.IdBatch" ), ValueMetaInterface.TYPE_INTEGER, 18 ) );
