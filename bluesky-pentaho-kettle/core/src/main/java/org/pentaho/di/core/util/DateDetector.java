...
public class DateDetector {
   ...
   *
   * @return {@link String} string wich represented Date Format
   */
   ...
   * @return {@link Date} converted from dateString by detected format
   ...
   * @return {@link Date} converted from dateString by format
   * @throws ParseException
   ...
   * @return {@link String} string which represented Date Format or null
   * 
   */
