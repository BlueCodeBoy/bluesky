...
public class Hive2ShimDatabaseMeta extends BaseDatabaseMeta implements DatabaseInterface {
    ...
    public Hive2ShimDatabaseMeta() throws Throwable {
    }
     ...
     * @throws Throwable
     */
    Hive2ShimDatabaseMeta( int majorVersion, int minorVersion ) throws Throwable {
