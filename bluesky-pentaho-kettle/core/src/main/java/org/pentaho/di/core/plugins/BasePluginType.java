...
public abstract class BasePluginType implements PluginTypeInterface {
  ...
  protected void populateFolders( String xmlSubfolder ) {
    ...
    String jarWholePath = BasePluginType.class.getProtectionDomain().getCodeSource().getLocation().getFile();
    try {
    ...
    pluginFolders.add( new PluginFolder( jarPath+ File.separator + "plugins", false, true ) );
    ...
    String folder=url.getPath()+ File.separator + "plugins";
  ...
  protected List<JarFileAnnotationPlugin> findAnnotatedClassFiles( String annotationClassName ) {
    ...
    //
    List<PluginFolderInterface> list = getPluginFolders();
    StringBuffer stringBuffer = new StringBuffer();
    for ( PluginFolderInterface pluginFolder : list) {
        stringBuffer.append("\n");
        stringBuffer.append(pluginFolder.getFolder());
        stringBuffer.append("\n");
    }
  ...
  protected List<FileObject> findPluginFiles( String folder, final String regex ) {
    ...
    System.out.println("PluginFilesFolder:"+folder);
    try {
  ...
  protected void registerPluginJars() throws KettlePluginException {
    ...
    for ( JarFileAnnotationPlugin jarFilePlugin : jarFilePlugins ) {
      System.out.println("pluginJarsFolder:"+jarFilePlugin.getJarFile());
