...
public class PropsWebUI extends Props {
	...
	public static PropsWebUI getInstance() {
		if (props != null) {
			return (PropsWebUI) props;
		}
	...
	private PropsWebUI(int t) {
		super(t);
	}

	private PropsWebUI(String filename) {
		super(filename);
	}
	...
	public static Point calculateGridPosition(Point p) {
		int gridSize = PropsWebUI.getInstance().getCanvasGridSize();
		if (gridSize > 1) {
			// Snap to grid...
			//
